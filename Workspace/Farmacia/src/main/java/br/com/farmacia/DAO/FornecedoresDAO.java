...
//	COMANDOS PARA TESTAR A COMUNICAÇÃO COM O MYSQL (salvar, editar, excluir e buscas por codigo, descrição e listas)
//	OBS: DEIXAR DESCOMENTADO SOMENTE O QUE FOR TESTAR.
...
//		SALVAR REGISTRO
		...
		f1.setDescricao("SANTÍSSIMO");

		Fornecedores f2 = new Fornecedores();
		f2.setDescricao("AUGUSTO VASCONCELOS");
...
//		Fornecedores f1 = new Fornecedores();
//		f1.setCodigo(1);
//		f1.setDescricao("SENADOR CAMARÁ");
//		
//		FornecedoresDAO fdao = new FornecedoresDAO();
//		
//		try {
